				...
				<div className="relative z-10 w-full px-6 lg:px-12 xl:px-16 py-16 lg:py-20">
					<div className="max-w-4xl mx-auto text-center">
						<div className="inline-flex items-center gap-2 bg-[#C4A962]/10 border border-[#C4A962]/30 rounded-full px-4 py-2 backdrop-blur-sm mb-6">
							...
							<span className="text-sm font-medium text-[#D4B673]">Worldwide Delivery</span>
						</div>
				...
				<div className="max-w-4xl mx-auto space-y-12">
					...
					<div className="vero-card rounded-xl p-8 border border-[#C4A962]/20">
						<div className="flex items-start gap-4 mb-6">
							<div className="w-12 h-12 bg-gradient-to-br from-[#C4A962]/10 to-[#D4B673]/10 rounded-lg flex items-center justify-center flex-shrink-0">
								<Package className="w-6 h-6 text-[#C4A962]" />
							</div>
							<div className="flex-1">
								<h2 className="text-2xl font-semibold text-[#111827] mb-3">Shipping Information</h2>
								...
								<div className="grid md:grid-cols-2 gap-6">
									<div className="bg-gradient-to-br from-[#F5E6D3]/20 to-white rounded-lg p-5 border border-[#C4A962]/10">
										<div className="flex items-center gap-3 mb-3">
											<Truck className="w-5 h-5 text-[#C4A962]" />
											<h3 className="font-semibold text-[#111827]">Standard Shipping</h3>
										</div>
										<ul className="space-y-2 text-sm text-[#6B7280]">
											<li className="flex items-start gap-2">
												<span className="w-1.5 h-1.5 bg-[#C4A962] rounded-full mt-1.5 flex-shrink-0" />
									...
									<div className="bg-gradient-to-br from-[#C4A962]/10 to-white rounded-lg p-5 border border-[#C4A962]/20">
										<div className="flex items-center gap-3 mb-3">
											<Package className="w-5 h-5 text-[#C4A962]" />
											<h3 className="font-semibold text-[#111827]">Express Shipping</h3>
										</div>
										<ul className="space-y-2 text-sm text-[#6B7280]">
											<li className="flex items-start gap-2">
												<span className="w-1.5 h-1.5 bg-[#C4A962] rounded-full mt-1.5 flex-shrink-0" />
					...
					<div className="vero-card rounded-xl p-8 border border-[#C4A962]/20">
						<div className="flex items-start gap-4 mb-4">
							...
							<div className="flex-1">
								<h2 className="text-2xl font-semibold text-[#111827] mb-3">Order Processing</h2>
								...
								<ul className="space-y-3 text-[#6B7280]">
									<li className="flex items-start gap-3">
										...
										<span>
											<strong className="text-[#111827]">In-Stock Items:</strong> Processed within 1-2
											business days
										</span>
									</li>
									<li className="flex items-start gap-3">
										<CheckCircle className="w-5 h-5 text-[#C4A962] flex-shrink-0 mt-0.5" />
										<span>
											<strong className="text-[#111827]">Pre-Order Items:</strong> Shipped as soon as stock
									...
									<li className="flex items-start gap-3">
										<CheckCircle className="w-5 h-5 text-[#C4A962] flex-shrink-0 mt-0.5" />
										<span>
											<strong className="text-[#111827]">Custom Orders:</strong> Processing time varies (we'll
											notify you)
										</span>
									</li>
								</ul>
					...
					<div className="vero-card rounded-xl p-8 border border-[#C4A962]/20">
						<div className="flex items-start gap-4 mb-4">
							...
							<div className="flex-1">
								<h2 className="text-2xl font-semibold text-[#111827] mb-3">International Shipping</h2>
								<p className="text-[#6B7280] leading-relaxed mb-4">
					...
					<div className="vero-card rounded-xl p-8 border border-[#C4A962]/20">
						<div className="flex items-start gap-4 mb-4">
							...
							<div>
								<h2 className="text-2xl font-semibold text-[#111827] mb-3">Premium Packaging</h2>
					...
					<div className="vero-card rounded-xl p-8 border border-[#C4A962]/20 bg-gradient-to-br from-[#F5E6D3]/20 to-white">
						<div className="flex items-start gap-4 mb-6">
							<div className="w-12 h-12 bg-gradient-to-br from-[#C4A962]/10 to-[#D4B673]/10 rounded-lg flex items-center justify-center flex-shrink-0">
								<RotateCcw className="w-6 h-6 text-[#C4A962]" />
							</div>
							<div className="flex-1">
								<h2 className="text-2xl font-semibold text-[#111827] mb-3">Return Policy</h2>
								<p className="text-[#6B7280] leading-relaxed mb-6">
								...
								<div className="space-y-4">
									<div className="bg-white rounded-lg p-5 border border-[#C4A962]/10">
								...
								<div className="mt-6 p-5 bg-[#C4A962]/5 rounded-lg border border-[#C4A962]/20">
									<h3 className="font-semibold text-[#111827] mb-2">How to Return</h3>
									<ol className="space-y-2 text-sm text-[#6B7280]">
										<li className="flex items-start gap-3">
											<span className="font-bold text-[#C4A962] flex-shrink-0">1.</span>
											<span>Contact our customer service at info@veromodels.com with your order number</span>
										</li>
										<li className="flex items-start gap-3">
											<span className="font-bold text-[#C4A962] flex-shrink-0">2.</span>
											<span>Receive return authorization and shipping instructions</span>
										</li>
										<li className="flex items-start gap-3">
											<span className="font-bold text-[#C4A962] flex-shrink-0">3.</span>
											<span>Pack the item securely in original packaging</span>
										</li>
										<li className="flex items-start gap-3">
											<span className="font-bold text-[#C4A962] flex-shrink-0">4.</span>
											<span>Ship to provided address with tracking</span>
										</li>
										<li className="flex items-start gap-3">
											<span className="font-bold text-[#C4A962] flex-shrink-0">5.</span>
