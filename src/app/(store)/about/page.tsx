		...
		<div className="min-h-screen bg-white">
			...
			<section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
				...
				<div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
					<div className="inline-flex items-center gap-2 bg-[#C4A962]/10 border border-[#C4A962]/30 rounded-full px-6 py-2 backdrop-blur-sm mb-8">
						<span className="text-sm font-medium text-[#D4B673]">Est. 2024 • Premium Die-Cast Models</span>
					</div>
				...
				<div className="grid md:grid-cols-2 gap-16 items-center">
					<div className="space-y-6">
						...
						<div className="space-y-4 text-[#6B7280] text-lg leading-relaxed">
							...
							<p className="text-[#C4A962] font-medium">
					...
					<div className="relative h-[500px] rounded-2xl overflow-hidden group">
						<div className="absolute inset-0 bg-gradient-to-br from-[#C4A962]/10 to-[#0A0A0A]/30 z-10 group-hover:from-[#C4A962]/20 transition-all" />
						<Image
			...
			<section className="border-y border-[#C4A962]/20 bg-gradient-to-b from-[#FDFBF7] via-white to-[#FDFBF7] py-20">
				<div className="max-w-5xl mx-auto px-6 text-center">
					<h2 className="text-4xl md:text-5xl font-light text-[#111827] mb-8">
						Our <span className="vero-elegant-text">Mission</span>
					</h2>
					<p className="text-xl text-[#6B7280] leading-relaxed max-w-4xl mx-auto">
						...
						<span className="text-[#C4A962] font-semibold">luxury, authenticity, exclusivity</span> and{" "}
						<span className="text-[#C4A962] font-semibold">nostalgia</span> so every customer can experience
			...
			<section className="max-w-7xl mx-auto px-6 py-20">
				...
				<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
					{[
						...
						>
							<div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-[#C4A962]/10 to-[#D4B673]/10 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
								<value.icon className="w-10 h-10 text-[#C4A962]" />
							</div>
							<h3 className="text-xl font-bold text-[#C4A962] mb-4 uppercase tracking-wider">
								{value.title}
							</h3>
