				...
				<form onSubmit={handleSubmit} className="vero-card p-8 md:p-12">
					...
					<div className="mb-12">
						...
						<div className="grid md:grid-cols-2 gap-6">
							...
							<div>
								<label className="block text-yellow-400/80 mb-2 text-sm font-medium">Phone Number</label>
								<input
									type="tel"
					...
					<div className="mb-12">
						...
						<div className="grid md:grid-cols-2 gap-6">
							...
							<div>
								<label className="block text-yellow-400/80 mb-2 text-sm font-medium">Year / Generation</label>
								<input
									type="text"
									value={formData.year}
							...
							<div>
								<label className="block text-yellow-400/80 mb-2 text-sm font-medium">Preferred Color</label>
								<input
									type="text"
