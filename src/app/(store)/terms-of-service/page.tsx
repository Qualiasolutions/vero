import { FileText, Scale, ShoppingBag, AlertCircle, CheckCircle, XCircle } from "lucide-react";
						...
						<div className="flex items-start gap-4 mb-4">
							...
							<div>
								...
								<p className="text-[#6C757D] leading-relaxed">
									These Terms of Service constitute a legally binding agreement between you and Veromodels concerning
									your access to and use of our website and services. By accessing or using our website, you agree to
									be bound by these Terms. If you disagree with any part of the terms, then you may not access the service.
								</p>
							</div>
						</div>
					</div>
						...
						<div className="flex items-start gap-4 mb-4">
							...
							<div className="flex-1">
								...
								<p className="text-[#6C757D] leading-relaxed mb-4">
									...
									we cannot guarantee that your device's display accurately reflects the actual product colors.
								</p>
								<ul className="space-y-3 text-[#6C757D]">
									<li className="flex items-start gap-3">
										<span className="w-2 h-2 bg-[#D4AF37] rounded-full mt-2 flex-shrink-0" />
										<span>All products are authentic 1:18 scale die-cast models from licensed manufacturers</span>
									</li>
									<li className="flex items-start gap-3">
										<span className="w-2 h-2 bg-[#D4AF37] rounded-full mt-2 flex-shrink-0" />
					...
					<div className="vero-card rounded-xl p-8 border border-[#D4AF37]/20">
						<div className="flex items-start gap-4 mb-4">
							...
							<div className="flex-1">
								...
								<p className="text-[#6C757D] leading-relaxed mb-4">
									When you place an order through our website, you are offering to purchase a product subject to these Terms.
								</p>
								<ul className="space-y-3 text-[#6C757D]">
									<li className="flex items-start gap-3">
										<span className="w-2 h-2 bg-[#D4AF37] rounded-full mt-2 flex-shrink-0" />
						...
						<div className="flex items-start gap-4 mb-4">
							...
							<div>
								...
								<p className="text-[#6C757D] leading-relaxed">
									...
									property of Veromodels and its licensors. The Service is protected by copyright, trademark, and
					...
					<div className="vero-card rounded-xl p-8 border border-[#D4AF37]/20">
						<div className="flex items-start gap-4 mb-4">
							...
							<div className="flex-1">
								...
								<p className="text-[#6C757D] leading-relaxed mb-4">
									In no event shall Veromodels, nor its directors, employees, partners, agents, suppliers, or affiliates,
						...
						<div className="flex items-start gap-4 mb-4">
							...
							<div className="flex-1">
								...
								<ul className="space-y-3 text-[#6C757D]">
									...
									<li className="flex items-start gap-3">
										<span className="w-2 h-2 bg-[#D4AF37] rounded-full mt-2 flex-shrink-0" />
										<span>To transmit any advertising or promotional material without our prior written consent</span>
									</li>
									<li className="flex items-start gap-3">
										<span className="w-2 h-2 bg-[#D4AF37] rounded-full mt-2 flex-shrink-0" />
