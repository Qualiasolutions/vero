				...
				<div className="relative z-10 w-full px-6 lg:px-12 xl:px-16 py-16 lg:py-20">
					<div className="max-w-4xl mx-auto text-center">
						<div className="inline-flex items-center gap-2 bg-[#C4A962]/10 border border-[#C4A962]/30 rounded-full px-4 py-2 backdrop-blur-sm mb-6">
							...
							<span className="text-sm font-medium text-[#D4B673]">Legal Agreement</span>
						</div>
				...
				<div className="max-w-4xl mx-auto space-y-12">
					...
					<div className="vero-card rounded-xl p-8 border border-[#C4A962]/20">
						<div className="flex items-start gap-4 mb-4">
							...
							<div>
								<h2 className="text-2xl font-semibold text-[#111827] mb-3">Agreement to Terms</h2>
					...
					<div className="vero-card rounded-xl p-8 border border-[#C4A962]/20">
						<div className="flex items-start gap-4 mb-4">
							<div className="w-12 h-12 bg-gradient-to-br from-[#C4A962]/10 to-[#D4B673]/10 rounded-lg flex items-center justify-center flex-shrink-0">
								<ShoppingBag className="w-6 h-6 text-[#C4A962]" />
							</div>
							<div className="flex-1">
								<h2 className="text-2xl font-semibold text-[#111827] mb-3">Products & Pricing</h2>
					...
					<div className="vero-card rounded-xl p-8 border border-[#C4A962]/20">
						<div className="flex items-start gap-4 mb-4">
							<div className="w-12 h-12 bg-gradient-to-br from-[#C4A962]/10 to-[#D4B673]/10 rounded-lg flex items-center justify-center flex-shrink-0">
								<CheckCircle className="w-6 h-6 text-[#C4A962]" />
							</div>
							<div className="flex-1">
								<h2 className="text-2xl font-semibold text-[#111827] mb-3">Orders & Payment</h2>
								<p className="text-[#6B7280] leading-relaxed mb-4">
					...
					<div className="vero-card rounded-xl p-8 border border-[#C4A962]/20">
						<div className="flex items-start gap-4 mb-4">
							<div className="w-12 h-12 bg-gradient-to-br from-[#C4A962]/10 to-[#D4B673]/10 rounded-lg flex items-center justify-center flex-shrink-0">
								<Scale className="w-6 h-6 text-[#C4A962]" />
							</div>
							<div>
								<h2 className="text-2xl font-semibold text-[#111827] mb-3">Intellectual Property</h2>
								<p className="text-[#6B7280] leading-relaxed">
					...
					<div className="vero-card rounded-xl p-8 border border-[#C4A962]/20">
						<div className="flex items-start gap-4 mb-4">
							<div className="w-12 h-12 bg-gradient-to-br from-[#C4A962]/10 to-[#D4B673]/10 rounded-lg flex items-center justify-center flex-shrink-0">
								<AlertCircle className="w-6 h-6 text-[#C4A962]" />
							</div>
							<div className="flex-1">
								<h2 className="text-2xl font-semibold text-[#111827] mb-3">Limitation of Liability</h2>
								<p className="text-[#6B7280] leading-relaxed mb-4">
					...
					<div className="vero-card rounded-xl p-8 border border-[#C4A962]/20">
						<div className="flex items-start gap-4 mb-4">
							<div className="w-12 h-12 bg-gradient-to-br from-[#C4A962]/10 to-[#D4B673]/10 rounded-lg flex items-center justify-center flex-shrink-0">
								<XCircle className="w-6 h-6 text-[#C4A962]" />
							</div>
							<div className="flex-1">
								<h2 className="text-2xl font-semibold text-[#111827] mb-3">Prohibited Uses</h2>
								<p className="text-[#6B7280] leading-relaxed mb-4">
					...
					<div className="vero-card rounded-xl p-8 border border-[#C4A962]/20 bg-gradient-to-br from-[#F5E6D3]/20 to-white">
						<div className="flex items-start gap-4">
							...
							<div>
								<h2 className="text-2xl font-semibold text-[#111827] mb-3">Changes to Terms</h2>
								<p className="text-[#6B7280] leading-relaxed mb-4">
