...
export default function ProductsClient({ initialProducts, locale = "en-US" }: ProductsClientProps) {
	...
	return (
		<main className="min-h-screen bg-[var(--selfridges-bg-primary)]">
				...
				<div className="relative z-10 h-full flex flex-col items-center justify-center px-6 lg:px-12">
					...
					<div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 mb-8">
						<div className="text-center">
							<div className="text-3xl md:text-4xl font-bold text-white mb-1">{initialProducts.length}+</div>
			...
			{/* Filters and Results */}
			<div id="collection" className="container mx-auto px-4 py-8">
				<div className="flex flex-col lg:flex-row gap-8">
					{/* Filters Sidebar */}
					<div className="lg:w-80 flex-shrink-0">
						<ProductFiltersClient products={initialProducts} filters={filters} onFiltersChange={setFilters} />
					</div>
						...
						<div className="flex items-center justify-between mb-6">
							...
							{filteredProducts.length !== initialProducts.length && (
								<p className="text-sm text-[var(--selfridges-text-secondary)]">
									Showing {filteredProducts.length} of {initialProducts.length} models
								</p>
							)}
						</div>
