					...
					<div className="text-left space-y-4 mt-12">
						<div className="flex items-start gap-4">
							...
							<div>
								...
								<div className="text-sm text-white/60">Limited edition models and pre-orders</div>
							</div>
						</div>
						<div className="flex items-start gap-4">
							<div className="w-8 h-8 rounded-full bg-[#A89050]/15 flex items-center justify-center flex-shrink-0 mt-1 border border-[#A89050]/30">
							...
							<div>
								...
								<div className="text-sm text-white/60">Safe checkout with Stripe integration</div>
							</div>
						</div>
						<div className="flex items-start gap-4">
							<div className="w-8 h-8 rounded-full bg-[#A89050]/15 flex items-center justify-center flex-shrink-0 mt-1 border border-[#A89050]/30">
							...
							<div>
								...
								<div className="text-sm text-white/60">Track your collection and orders</div>
							</div>
						</div>
					</div>
				</div>
