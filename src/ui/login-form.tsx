	...
	return (
		<div className={cn("flex flex-col gap-6", className)} {...props}>
			<div className="vero-glass-card">
				<div className="mb-8">
					<h2 className="text-3xl font-light text-[#111827] mb-2 tracking-wide">Sign In</h2>
					<p className="text-[#6B7280]">Access your premium collection</p>
				</div>
					...
					<div className="grid gap-6">
						...
						<div className="grid gap-5">
							...
							<div className="grid gap-2">
								<div className="flex items-center justify-between">
									...
									<a href="#" className="text-xs text-[#C4A962] hover:text-[#A89050] transition-colors">
										Forgot password?
									</a>
								</div>
								<Input
						...
						<div className="relative my-2">
							...
							<div className="relative flex justify-center text-xs uppercase">
								<span className="bg-white px-3 text-[#6B7280]">New to Veromodels?</span>
							</div>
						</div>
