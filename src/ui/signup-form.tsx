	...
	return (
		<div className={cn("flex flex-col gap-6", className)} {...props}>
			<div className="vero-glass-card">
				<div className="mb-8">
					<h2 className="text-3xl font-light text-[#212529] mb-2 tracking-wide">Create Account</h2>
					<p className="text-[#6C757D]">Join the Veromodels collector community</p>
				</div>
					...
					<div className="grid gap-6">
						...
						<div className="grid gap-5">
							<div className="grid gap-2">
								<Label htmlFor="name" className="text-[#212529] font-medium text-sm">
									Full Name
								</Label>
								<Input
									id="name"
							...
							<div className="grid gap-2">
								...
								<Input
									...
									disabled={isPending}
								/>
								<p className="text-xs text-[#6C757D]">Must be at least 8 characters long</p>
							</div>

							<div className="grid gap-2">
								<Label htmlFor="confirm-password" className="text-[#212529] font-medium text-sm">
									Confirm Password
								</Label>
								<Input
									id="confirm-password"
						...
						<div className="relative my-2">
							...
							<div className="relative flex justify-center text-xs uppercase">
								<span className="bg-white px-3 text-[#6C757D]">Already a member?</span>
							</div>
						</div>
